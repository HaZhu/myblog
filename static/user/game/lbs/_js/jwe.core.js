...
/*新棋子代码*/
function uniCode(n){
	var html = "<div class='uni' lang="+n+" ><img lang="+n+" src='user/game/lbs/_img/uni/"+_dir+"/"+n+"."+_extName+"' /></div>";
	return html;
}
/*动态背景代码*/
function bgImgCode(n){
	var html = "url(user/game/lbs/_img/bg/"+_dir+"/"+n+"."+_bgExtName+")";
	return html;
}
/*动态gi亮相1代码*/
function giCode1(n){
//	var html = "url(_img/sexy/heroPic1/"+n+".png)";
	var html = "<img src='user/game/lbs/_img/sexy/heroPic1/"+n+".png' />";
	return html;
}
...
function xPCode(n){
	...
	var pic = "E"+s+".JPG";
	var html = "<img src='user/game/lbs/_img/sexy/endPic/"+pic+"' />";
//	debug(html)
	return html;
}
