...
exports.apiAdminAddUser=function(req,res,db){
    const fs = require("fs");
    ...
    form.parse(req, function (err, fields, files) {
        ...
        if(_IMG==""){
           ...
           _IMG='user/images/public/head.png';
        }
                                ...
                                if (result.length > 0) {
                                    res.json({
                                        ...
                                        db.insert('user', {
                                            ...
                                            'gender': fields.gender, // 学历
                                            'marriage': fields.marriage, // 婚姻
                                            'studyInfo': fields.studyInfo, // 学历
